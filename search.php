...
<div class="container">
  <div class="col-md-9 col-xs-12">
    ...
    <?php $spubcat = get_categoriesclassic(); ?>
          <?php if (!isset($spubcat[2]) && !isset($spubcat[1]) && isset($spubcat[0])) { ?>
            <?php ;
            echo search_title(). ': ';  
              foreach(get_subcategories() as $subcat) {
                
                echo " / <a href='".$subcat["url"]."'><span>".$subcat["s_name"]."</span> <span class='color'>(" . get_category_num_items($subcat) . ")</span></a>";
        ...
        <div class="btn-group">
            ...
            <div class="col-md-12 panel">
              ...
              <!-- Useful info -->
                <div id="useful_info" class="bordered-box">
                    <h2 class="title-maps"><?php _e('All categories', 'classic'); ?></h2>
            ...
            <div class="col-md-12 panel">
                ...
                <form action="<?php echo osc_base_url(true); ?>" method="get" class="nocsrf">
                    ...
                    <fieldset>
                        <h4 style="font-size: 16px"><?php _e('Price', 'classic') ; ?></h4>
