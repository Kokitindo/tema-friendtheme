            ...
            <div class="container-fluid">
              ...
              <div class="col-sm-8 col-md-5 col-lg-4 p-r-0 super-xs-right">
                  ...
                  <ul class="nav navbar-nav pull-right hidden-on-super-xs">
                    ...
                    <!-- creaet user session login -->
                    <?php if(osc_users_enabled()) { ?>
                    <?php if( osc_is_web_user_logged_in() ) { ?>
                      <li class="hidden-xs hidden-sm">
                        <a href="<?php echo osc_user_dashboard_url(); ?>"><button href="#" class="btn btn-danger btn-register" style="border-color: white!important"><?php echo sprintf(__('Hi %s', 'classic'), osc_logged_user_name() . '!'); ?></button></a>
                      </li>
                      <li class="hidden-xs hidden-sm">
                        <a class="nav-link" href="<?php echo osc_user_logout_url(); ?>"><button class="btn btn-default btn-register thebtnlogin"><?php _e("Logout", 'classic'); ?></button>
                        </a>
                      </li>
